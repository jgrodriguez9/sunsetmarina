        ...
        <Row className="mt-2">
          <Col xs="12" md="12">
            ...
            >
              ...
              <TabPane tabId="3">
                {customActiveTab === "3" && <PaymentClient formik={formik} />}
              </TabPane>
              <TabPane tabId="4">
                {customActiveTab === "4" && (
              ...
              <TabPane tabId="5">
                {customActiveTab === "5" && <BoatClient formik={formik} />}
              </TabPane>
              <TabPane tabId="6">
                {customActiveTab === "6" && <DocumentClient formik={formik} />}
              </TabPane>
              <TabPane tabId="7">
                {customActiveTab === "7" && <NoteClient formik={formik} />}
              </TabPane>
              <TabPane tabId="8">
                {customActiveTab === "8" && <ContactClient formik={formik} />}
              </TabPane>
              <TabPane tabId="10">
                {customActiveTab === "10" && (
