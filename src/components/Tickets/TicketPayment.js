    ...
    <Document>
      <Page size="A4" style={styles.body}>
        <View style={[styles.containerFlexCenter, styles.flexCenter]}>
          <Text style={{ fontSize: 14, margin: "auto" }}>Sunset Admiral</Text>
          <Text style={{ fontSize: 12, margin: "auto", marginTop: 10 }}>
        ...
        >
          ...
          {ticket.chargesSuccess.map((it, idx) => (
            <View style={stylesTable.row} wrap={false} key={`charge-${idx}`}>
              ...
              <View style={stylesTable.row2}>
                ...
                <Text>
                  {it.interest === 0 ? "$0.00" : formatNumber(it.interest)}
                </Text>
              </View>
            </View>
          ))}
          ...
          <View style={[stylesTable.row, { margintTop: 20 }]} wrap={false}>
            <View style={stylesTable.row1}>
              <Text>Total</Text>
            </View>
            <View style={stylesTable.row2}>
        ...
        <View style={{ marginTop: 35, textAlign: "center" }}>
          <Text style={{ fontSize: 12, marginBottom: 5 }}>
            {moment(ticket.payment.dateCreated, "YYYY-MM-DDTHH:mm").format(
              "DD-MM-YYYY"
            )}
          </Text>
          <Text style={{ fontSize: 12, marginBottom: 5 }}>Gracias</Text>
        </View>
      </Page>
    </Document>
  );
