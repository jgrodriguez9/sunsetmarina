...
import { CORREO_VALID, ERROR_SERVER, FIELD_REQUIRED, SAVE_SUCCESS, SELECT_OPTION, UPDATE_SUCCESS } from "../../../constants/messages";
...
export default function FormContactClient({item, setOpenModalAdd, setRefetch}){
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            email: Yup.string().email(CORREO_VALID).required(FIELD_REQUIRED),
    ...
    return(
        <div className="needs-validation">
            ...
            <Row>
                <Col xs="12" md="3">
                    <Label htmlFor="boatType" className="mb-0">Parentesco</Label>
                    <Select
                        value={formik.values.description ? {label: formik.values.description, value: formik.values.description} : null}
                        onChange={(value) => {
                    ...
                    />
                    {
                        ...
                        <div className="invalid-tooltip d-block">{formik.errors.description}</div>
                    }
                </Col>
            </Row>
            <hr />
