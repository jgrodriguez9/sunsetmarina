...
const fields = [
        {label: 'Nombre', width: 3}, {label: 'Habilitado', width: 2}, {label: null, width: 7},
    ...
    return(
        <div className="page-content">
            <Container fluid>
                ...
                <Row className="pb-5">
                  <Col lg="12">
                    {states.loading && <FormLoader fields={fields} titleCard='Editar Categoría de Cliente' />}
                    {states.success && <CardMain
                                            title='Editar Categoría de Cliente'
                                            children={<FormCategoriaCliente item={item} btnTextSubmit="Actualizar"/>}
                                        />}
...
export default withRouter(EditCategoriaCliente)