...
function TipoDocumento(){  
    ...
    const editAction = (row) => {
        history.push(`/clientcategory/edit/${row.original.id}`)
    }
    ...
    const goPageCreate = () => {
        history.push("/clientcategory/create")
    }
    ...
    const cardHandleList = (
        ...
        <Row>
            <Col xs="12" xl="12">
                <TableLoader columns={[{name: "Nombre", width: '30%'}, {name: "Descripción", width: '30%'}, {name: "Habilitado", width: '30%'}, {name: "Acciones", width: '10%'}]} />
            </Col>
        </Row> :
        <Row>
            <Col xl="12">                                    
