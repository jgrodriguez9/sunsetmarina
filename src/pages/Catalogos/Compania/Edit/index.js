...
const fields = [
        {label: 'Nombre', width: 3}, {label: 'Sitio web', width: 3}, {label: 'Teléfono', width: 3}, {label: 'Habilitado', width: 2},
        {label: 'Ciudad', width: 3}, {label: 'Estado', width: 3}, {label: 'País', width: 3},
    ...
    return(
        <div className="page-content">
            <Container fluid>
                ...
                <Row className="pb-5">
                  <Col lg="12">
                    {states.loading && <FormLoader fields={fields} titleCard='Editar Compañía' />}
                    {states.success && <CardMain
                                            title='Editar Compañía'
                                            children={<FormCompania item={item} btnTextSubmit="Actualizar"/>}
                                        />}
...
export default withRouter(EditCompania)