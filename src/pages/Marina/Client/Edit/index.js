...
const fields = [
	{ label: '.', width: 3, height: '88px' },
	{ label: '.', width: 3, height: '88px' },
	{ label: '.', width: 3, height: '88px' },
	{ label: '.', width: 3, height: '88px' },
	{ label: 'Nombre', width: 5, height: '80px' },
	{ label: null, width: 7 },
	{ label: 'Nombre', width: 5 },
	{ label: null, width: 2 },
	{ label: 'Teléfono', width: 5 },
	{ label: 'Apellidos', width: 5 },
	{ label: null, width: 2 },
	{ label: 'RFC', width: 5 },
	{ label: 'Identificación', width: 5 },
	{ label: null, width: 2 },
	{ label: 'Fecha nacimiento', width: 5 },
	{ label: 'Correo electrónico', width: 5 },
	{ label: null, width: 2 },
	{ label: 'Categoría del cliente', width: 5 },
];
